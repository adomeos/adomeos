...
interface ConfirmationPageProps {
  ...
  answers: Answer[];
  analysisResult?: { analysis: string; summary: string } | null;
}
...
export function ConfirmationPage({ leadData, answers, analysisResult }: ConfirmationPageProps) {
  // Use AI summary if available, otherwise fallback to rule-based
  const summary = analysisResult?.summary || generateSummary(answers);
