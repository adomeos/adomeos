...
export function ConfirmationPage({ leadData }: ConfirmationPageProps) {
  return (
    ...
    >
      ...
      <h1 className="text-3xl md:text-[36px] font-bold leading-tight">
        C'est bon {leadData.firstName} !
      </h1>
      ...
      >
        <div className="bg-card border border-border rounded-2xl p-8">
          ...
          <h2 className="text-xl font-semibold mb-3">
            Ouvre WhatsApp maintenant
          </h2>
          
          <p className="text-muted-foreground mb-6 max-w-[360px] mx-auto">
            Tu vas recevoir ton analyse détaillée avec tes patterns, ton angle mort, et pourquoi ça n'a pas marché jusqu'ici.
          </p>

          <Button
            size="lg"
            className="w-full max-w-[320px] h-14 text-lg font-semibold bg-[#25D366] hover:bg-[#20BD5A] text-white rounded-xl gap-3"
      ...
      <p className="mt-6 text-sm text-muted-foreground">
        Pas reçu ? Vérifie tes messages dans quelques minutes.
      </p>
    </motion.div>
  );
}
