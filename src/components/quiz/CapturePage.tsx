    ...
    <motion.div
      ...
      <div className="bg-accent-dim border border-primary/30 rounded-2xl p-5 mb-8 flex items-start gap-3.5">
        ...
        <p className="text-[15px] leading-relaxed">
          <strong>Bonus :</strong> On bosse avec beaucoup d'entrepreneurs & d'investisseurs. Si ça matche, tu profitera donc aussi de la valeur de notre réseau et de ses membres.
        </p>
      </div>
          ...
          <div className="flex gap-3">
            <Input
              ...
              onChange={(e) => {
                ...
                if (!val.startsWith('+')) val = '+' + val.replace(/[^0-9]/g, '');else
                val = '+' + val.slice(1).replace(/[^0-9]/g, '');
                setCountryCode(val);
              }}
              className="w-20 h-14 text-base text-center bg-card border-border rounded-xl placeholder:text-muted-foreground focus:border-primary focus:bg-hover flex-shrink-0" />
